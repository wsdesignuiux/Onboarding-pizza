...
public class CarouselPagerAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CarouselPagerAdapter(LoginActivity context, FragmentManager fm) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        try {
            ...
            position = position % LoginActivity.count;
    ...
    public int getCount() {
        int count = 0;
        try {
            count = LoginActivity.count * LoginActivity.LOOPS;
        } catch (Exception e) {
